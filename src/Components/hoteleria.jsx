  ...
  useEffect(() => {
    ...
    map.current.on("load", () => {
      ...
      map.current.on("load", () => {
        ...
        // map.current.addSource('puntos-hoteles-destacados',{
        //   'type': 'geojson',
        //   'data': {
        ...
        //         'type': 'Feature',
        //         'properties':{
        //           'height': 80, //Altura persoalizada
        //           'base_height': 0,
        //           'color': '#FF5A5F'
        //         },
        //         'geometry':{'type': 'Point', 'coordinates': [crearRectangulo(-97.31908, 20.99095)]}
        //       },
        //       {
        //         'type' :'Feature',
        //         'properties' :{
        ...
        //           'color' :'#0f766e'
        //         },
        //         'geometry': {'type': 'Point', 'coordinates': [crearRectangulo(-97.319921, 20.99048)]}
        //       }
        //     ]
        //   }
        // });
        ...
        //   'id' : 'capa-hoteles-3d',
        //   'type' : 'fill-extrusion',
        //   'source' : 'puntos-hoteles-destacados',
        //   'paint' : {
        ...
        // function crearRectangulo(lng, lat, offset){
        //   return[
